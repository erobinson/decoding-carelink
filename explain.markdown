# ./status-quo.sh /dev/ttyUSB0 584923
## cat ./status-quo.sh
```bash
```
...
INFO:session:finished executing:ReadHistoryData:size[1024]:[page][13]:data[0]:
...
INFO:session:finished executing:ReadHistoryData:size[1024]:[page][7]:data[704]:
...
## commands session:finished: 33

```
INFO:session:finished executing:ReadBasalTemp:size[64]:data:{'duration': 0, 'rate': 0.0}
INFO:session:finished executing:ReadBatteryStatus:size[64]:data:{'status': 'normal', 'voltage': 1.2}
...
INFO:session:finished executing:ReadCurPageNumber:pages:18
...
INFO:session:finished executing:ReadHistoryData:size[1024]:[page][8]:data[1024]:
INFO:session:finished executing:ReadHistoryData:size[1024]:[page][9]:data[1024]:
INFO:session:finished executing:ReadPumpID:size[64]:data:'584923'
INFO:session:finished executing:ReadPumpModel:size[64]:data:'722'
INFO:session:finished executing:ReadRadioCtrlACL:size[64]:data:['408283', '------', '------']
INFO:session:finished executing:ReadRemainingInsulin:size[64]:data:42.4
INFO:session:finished executing:ReadRTC:size[64]:data:'2014-4-8T20:2:56'
INFO:session:finished executing:ReadSettings:size[64]:data:{'low_reservoir_warn_point': 20, 'keypad_lock_status': 0, 'maxBasal': 35, 'temp_basal': {'percent': 100, 'type': 'Units/hour'}, 'paradigm_enabled': 0, 'insulinConcentration': 100, 'audio_bolus_enable': True, 'variable_bolus_enable': False, 'alarm': {'volume': 1, 'mode': 2}, 'rf_enable': True, 'block_enable': False, 'timeformat': 0, 'auto_off_duration_hrs': 0, 'audio_bolus_size': 0.1, 'selected_pattern': 0, 'patterns_enabled': False, 'insulin_action_type': 2, 'maxBolus': 10.0, 'low_reservoir_warn_type': 0}
INFO:session:finished executing:ReadTotalsToday:size[64]:data:{'yesterday': 0.0, 'today': 0.0}
```
